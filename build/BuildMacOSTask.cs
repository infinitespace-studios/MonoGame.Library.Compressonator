...
public sealed class BuildMacOSTask : FrostingTask<BuildContext>
{
    ...
    public override void Run(BuildContext context)
    {
        ...
        context.StartProcess("cmake", new ProcessSettings { WorkingDirectory = buildWorkingDir, Arguments = "-DOPTION_ENABLE_ALL_APPS=OFF -DOPTION_BUILD_APPS_CMP_CLI=ON -DOPTION_BUILD_ASTC=ON -DCMAKE_OSX_ARCHITECTURES=\"x86_64\" CMakeLists.txt" });
